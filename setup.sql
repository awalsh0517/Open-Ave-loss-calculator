...
CREATE TABLE userInputs (
  ...
  isExternalRecruiterUsed VARCHAR(255) DEFAULT NULL,
  isOfferedSigningBonus VARCHAR(255) DEFAULT NULL,
  isOfferedRelocationBonus VARCHAR(255) DEFAULT NULL,
  isCorpRecuiterInvolved VARCHAR(255) DEFAULT NULL,
  isDirOfEngineeringInvolved VARCHAR(255) DEFAULT NULL,
  isItTechnicianInvolved VARCHAR(255) DEFAULT NULL,
  isHrManagerInvolved VARCHAR(255) DEFAULT NULL,
  isCeoInvolved VARCHAR(255) DEFAULT NULL,
  isPeerWorkerInvolved VARCHAR(255) DEFAULT NULL,
  ...
  productionDelays DECIMAL(7,2) DEFAULT NULL,
  createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  deletedAt DATETIME,
  PRIMARY KEY (id)
